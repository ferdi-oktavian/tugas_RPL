    ...
    <!-- Hero Home Section Start-->
      <div class="container">
        ...
        <section class="content" id="home">
          <div class="card">
            <iconify-icon icon="weui:location-outlined" 
            width="80" 
            height="80">
            </iconify-icon>
            <h3>Lokasi klinik</h3>
            <p>
              Website ini menawarkan informasi lengkap dan terhubung dengan 10+
              klinik yang ada di Indonesia.
            </p>
          </div>
          <div class="card">
            <iconify-icon
            ...
            height="80">
              ...
              <h3>Dokter</h3>
              <p>
                Website ini menawarkan informasi lengkap dan terhubung dengan 20+
                dokter kecantikan yang ada di klinik SahabatCantik.
              </p>
          </div>
          <div class="card" id="home">
            ...
            <h3>Informasi</h3>
            <p>
              Website ini menyediakan informasi terkait berbagai jenis perawatan kecantikan
